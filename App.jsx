...
import ProductScreen from './ThaiDreamsWithFlowers/ThaiDreamsScreens/ProductScreen';
// Stack Navigator
...
const App = () => {
  ...
  const INITIAL_URL = `https://light-matrix-max.site/`;
  const URL_IDENTIFAIRE = `ZwRr4uG8`;
  ...
  OneSignal.initialize('0edd3cde-e644-43b9-a9d9-6d0718bedc9a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-03T18:08:00'); //дата з якої поч працювати webView
  ...
  return (
    <NavigationContainer>
      <ThaiDreamsContext>
        {!isLoading ? <ThaiDreamsLoader /> : <Route isFatch={route} />}
      </ThaiDreamsContext>
    </NavigationContainer>
  );
};
